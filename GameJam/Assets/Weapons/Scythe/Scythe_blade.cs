...
public class Scythe_blade : MonoBehaviour
{
    public GameObject Player;
    string enermyTag;
    [SerializeField] public int MaxDmg = 18;
    [SerializeField] public int MinDmg = 4;
    [SerializeField] public int damage = 9;
    ...
    int DmgManage()
    {
        ...
        float weaponSpd = Mathf.Abs(joint2D.jointSpeed) / 400; // 700 = maxSpinSpeed
